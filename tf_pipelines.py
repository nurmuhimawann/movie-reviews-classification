...
Original file is located at
    https://colab.research.google.com/drive/1UAm2incdVQEdZZN6H2pVgsSjUS8qbJn-
...
[Movie Review Dataset](https://huggingface.co/datasets/rotten_tomatoes). This is a dataset of containing 4,265 positive and 4,265 negative processed sentences from Rotten Tomatoes movie reviews. This data was first used in Bo Pang and Lillian Lee, [``Seeing stars: Exploiting class relationships for sentiment categorization with respect to rating scales, Proceedings of the ACL, 2005.``](https://aclanthology.org/P05-1015/)
...
# export to csv
rotten_tomatoes["train"].to_csv(os.path.join(DATA_PATH, "rotten_tomatoes.csv"), index=None)
...
PIPELINE_NAME = "movie-reviews-pipeline"
SCHEMA_PIPELINE_NAME = "movie-reviews-tfdv-schema"

# Directory to store the artifacts that will be generated
...
TRANSFORM_MODULE_FILE = "movie_reviews_transform.py"
...
### **Tuner Component (Hyperparameter Tuning)**
"""

TUNER_MODULE_FILE = 'movie_reviews_tuner.py'
...
TRAINER_MODULE_FILE = "movie_reviews_trainer.py"
...
# visualize the evaluation results (tfma)
...
push_destination=pusher_pb2.PushDestination(
    filesystem=pusher_pb2.PushDestination.Filesystem(
        base_directory='serving_model_dir/movie-reviews-sentiment-model')
    )
)
